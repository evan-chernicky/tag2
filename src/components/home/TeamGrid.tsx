...
function TeamGrid() {
  return (
    <>
    <div className="lg:flex justify-center text-center text-white align-center items-center grid-rows-[350px] overflow-hidden">
        <div className="lg:w-1/3 w-full px-4 py-9">
    ...
    <div className="lg:flex justify-center text-center text-white align-center items-center grid-rows-[350px] overflow-hidden">
        ...
        <div className="lg:w-1/3 flex items-center justify-center w-full px-4 py-9">
